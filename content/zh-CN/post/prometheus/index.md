...
* [prometheus](prometheus/README.md)
    ...
    - [配置-配置文件](prometheus/configuration/configuration.md)
    - [配置-记录规则](prometheus/configuration/Recording_rules.md)
    - [配置-预警规则](prometheus/configuration/Altering_rules.md)
    - [配置-模板例子](prometheus/configuration/Template_examples.md)
    - [配置-模板参考](prometheus/configuration/Template_reference.md)
    - [配置-规则的单元测试](prometheus/configuration/Unit_Testing_for_Rules.md)
    - [查询-基本概念](prometheus/querying/Basics.md)
    - [查询-操作符](prometheus/querying/Operators.md)
    - [查询-函数](prometheus/querying/Functions.md)
    - [查询-举例](prometheus/querying/Examples.md)
    - [查询-HttpAPI](prometheus/querying/HTTP_API.md)
